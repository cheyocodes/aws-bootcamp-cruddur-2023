...
- [X] [Watched Ashish's Week 3 - Decenteralized Authentication](https://www.youtube.com/watch?v=tEJIeII66pY&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=39)
- [ ] [Watch Chirag Week 3 - Spending Considerations (Not yet posted)]()
- [X] [Setup Cognito User Pool](https://www.youtube.com/watch?v=9obl7rVgzJw&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=40)
- [X] [Implement Custom Signin Page](https://www.youtube.com/watch?v=9obl7rVgzJw&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=40)
- [X] [Implement Custom Signup Page](https://www.youtube.com/watch?v=T4X4yIzejTc&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=41)
- [X] [Implement Custom Confirmation Page](https://www.youtube.com/watch?v=T4X4yIzejTc&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=41)
- [X] [Implement Custom Recovery Page](https://www.youtube.com/watch?v=T4X4yIzejTc&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=41)
- [X] [Watch about different approaches to verifying JWTs](https://www.youtube.com/watch?v=nJjbI4BbasU&list=PLBfufR7vyJJ7k25byhRXJldB5AiwgNnWv&index=43)
...
- Client-side application best practices 
...
With AWS Cognito you have two options. Cognito user pools or identity pools. *Cognito user pools* allow users to sign in or sign up usign their email, phone or username. *Cognito identity pools*, on the other hand allow users to authenticate using a third party federation provider such as google, and exchange the authentication access token generated by this flow for temporary AWS credentials, that the application can use to access AWS resources. 
![Cognito User Pool Setup](./assets/week-03/cognito-01.png)
...
![Cognito User Pool Setup](./assets/week-03/cognito-02.png)
...
![Cognito User Pool Setup](./assets/week-03/cognito-03.png)
